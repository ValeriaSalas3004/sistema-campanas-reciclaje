...
public class ReportService {
    ...
    public Report editReport(Integer id, Report reportEdit){
        ...
        if(reportOp.isPresent()){
            ...
            report.setReportDate(reportEdit.getReportDate());
            report.setUser(reportEdit.getUser());
            report.setRecoZone(reportEdit.getRecoZone());
            report.setWasteType(reportEdit.getWasteType());
            report.setCampaign(reportEdit.getCampaign());
